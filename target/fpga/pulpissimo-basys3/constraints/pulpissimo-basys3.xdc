...
### Constraint File for the Basys3 board
...
#Create constraint for the clock input of the basys3 board (100MHz)
...
## PMOD JA as JTAG (Basys3 PMOD JA pins)
...
##PMOD JB for I2C and I2S (if needed in future)
...
## Switches (only 2 to match Nexys)
...
## SD Card using PMOD JD
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports pad_sdio_clk]
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS33} [get_ports pad_sdio_cmd]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports pad_sdio_data0]
set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS33} [get_ports pad_sdio_data1]
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports pad_sdio_data2]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports pad_sdio_data3]
set_property -dict {PACKAGE_PIN K2 IOSTANDARD LVCMOS33} [get_ports sdio_reset_o]
